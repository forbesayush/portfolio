...
export default function Hero({ onOpenBrief }) {
  return (
    <section id="home" className="relative min-h-[92vh] flex items-center justify-center pt-28 pb-20 overflow-hidden bg-slate-50 dark:bg-obsidian-950 transition-colors duration-300">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
          ...
          <div className="lg:col-span-7 text-left">
            ...
            <div className="inline-flex flex-wrap items-center gap-2 sm:gap-3 mb-6">
              <div className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full bg-white dark:bg-obsidian-850 border border-slate-200 dark:border-white/10 text-slate-700 dark:text-slate-300 text-xs font-mono tracking-wide shadow-sm">
                <span className="w-1.5 h-1.5 rounded-full bg-accent dark:bg-accent-dark animate-pulse"></span>
                {personalInfo.educationBadge}
              </div>
              <div className="hidden sm:inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full bg-white dark:bg-obsidian-850 border border-slate-200 dark:border-white/10 text-slate-600 dark:text-slate-400 text-xs font-mono tracking-wide shadow-sm">
            ...
            <div className="mb-3">
              <h1 className="text-xs sm:text-sm font-mono tracking-ultra text-slate-500 dark:text-slate-400 uppercase mb-2 font-semibold">
                Executive Portfolio &bull; Ayush Chatterjee
              </h1>
              <div className="text-4xl sm:text-6xl md:text-7xl font-display font-extrabold tracking-tight text-slate-950 dark:text-white uppercase transition-colors">
                {personalInfo.name}
              </div>
            </div>
            ...
            <div className="max-w-2xl mb-8">
              <blockquote className="text-xs sm:text-sm text-slate-600 dark:text-slate-400 leading-relaxed font-normal bg-white dark:bg-obsidian-900/50 border-l-4 border-accent dark:border-accent-dark pl-4 py-3 rounded-r-lg shadow-sm border border-slate-200/80 dark:border-white/5">
                "{personalInfo.bio}"
              </blockquote>
            </div>
            ...
            <div className="relative w-full max-w-md">
              ...
              <div className="relative rounded-3xl bg-white dark:bg-obsidian-850 p-3.5 border border-slate-200 dark:border-white/10 shadow-2xl overflow-hidden">
                ...
                <div className="relative rounded-2xl overflow-hidden aspect-[4/5] bg-slate-900">
                  ...
                  <div className="absolute inset-x-0 bottom-0 h-32 bg-gradient-to-t from-slate-950/80 via-slate-950/20 to-transparent"></div>

                  {/* Overlaid Bottom Details */}
                  <div className="absolute inset-x-0 bottom-0 p-4 text-left">
                    <div className="inline-flex items-center gap-1.5 px-2.5 py-1 rounded-full bg-slate-900/90 backdrop-blur-md border border-white/20 text-white text-[11px] font-mono tracking-wide mb-1">
                ...
                <div className="pt-3.5 pb-1 px-1 grid grid-cols-2 gap-2 text-left text-xs font-mono">
                  <div className="p-2.5 rounded-xl bg-slate-50 dark:bg-obsidian-950 border border-slate-200 dark:border-white/5">
                    <div className="text-[10px] text-slate-500 uppercase font-semibold">Location Focus</div>
